  ...
  return (
    <div className="home">
      ...
      <div className="home-hero">
        ...
        <h1>Welcome to <span className="gradient-cycle">EduTrack</span></h1>
        <p className="home-subtitle">
          A modern platform for managing students, courses, and instructors — all in one place.
        </p>
      ...
      <div className="home-cards">
        ...
        <div className="home-card card-blue">
          ...
          <span className="home-card-desc">
            Register students, update their profiles, and manage enrolments across courses.
          </span>
          <Link to="/students" className="home-card-explore">→ Explore</Link>
        </div>
        ...
        <div className="home-card card-green">
          ...
          <span className="home-card-desc">
            Browse the course catalogue, assign instructors, and track credit hours.
          </span>
          <Link to="/courses" className="home-card-explore">→ Explore</Link>
        </div>
        ...
        <div className="home-card card-orange">
          ...
          <Link to="/instructors" className="home-card-explore">→ Explore</Link>
        </div>
